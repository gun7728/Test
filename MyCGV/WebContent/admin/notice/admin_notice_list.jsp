    ...
    <section class="section1">
      <div>
        ...
        <table border=1>
          <tr>
            <td colspan="4">
              <a href="http://localhost:9000/MyCGV/admin/notice/admin_notice_write.jsp"><button type="button">글쓰기</button></a>
            </td>
          </tr>
          <tr>
            <th>번호</th>
          ...
          <tr>
            <td>1</td>
            <td><a href="http://localhost:9000/MyCGV/admin/notice/admin_notice_content.jsp">[CGV인재]임시 영업중단 안내</a></td>
            <td>2020.11.11</td>
            <td>71</td>
          </tr>
          <tr>
